...
export const Route = createFileRoute("/equipe")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Simon et Sylvain Goulet : deux générations de courtiers immobiliers au service de vos projets." },
      { property: "og:title", content: "Notre équipe de courtiers | Goulet Immobilier" },
      { property: "og:description", content: "Simon et Sylvain Goulet : deux générations de courtiers immobiliers au service de vos projets." },
    ...
    <>
      ...
      <section className="py-20 md:py-28">
        <div className="container-editorial space-y-20">
          {brokers.map((b) => (
            <Reveal key={b.slug} className="grid gap-10 lg:grid-cols-12">
              <div className="lg:col-span-5">
                <img src={b.image} alt={`${b.name}, ${b.title}`} width={900} height={1125} loading="lazy" className="aspect-4/5 w-full rounded-lg bg-secondary object-cover object-top" />
              </div>
              <div className="lg:col-span-7">
                ...
                <div className="mt-8 flex flex-wrap gap-3">
                  <Button asChild variant="ink" size="lg"><a href={b.phoneHref}>{b.phone}</a></Button>
                  <Button asChild variant="quiet" size="lg"><a href={`mailto:${b.email}`}>{b.email}</a></Button>
                </div>
